...
\label{chap:ci}
In this chapter we explain what Continuous Integration (CI) contains, and additionally describe the process steps, its benefits, challenges, and good practices of CI.
