...
\nomenclature{$ATDD$}{Acceptance TDD}
...
\include{kapitel/sw-reuse}
\include{kapitel/tdd}
\include{kapitel/ci}
\include{kapitel/microservices}
\include{kapitel/usage-scenario}
\include{kapitel/simile}
\include{kapitel/discussion}
\include{kapitel/future-work}
